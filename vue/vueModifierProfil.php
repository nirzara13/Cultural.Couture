...
<div class="col-xs-12 col-sm-6">
    ...
    <fieldset>
        <form id="profileForm" action="../controleur/modifierProfil.php" method="post">
            ...
            <input type="email" name="mailU" id="mailU" value="<?php echo isset($utilisateur['mailU']) ? htmlspecialchars($utilisateur['mailU']) : ''; ?>"><br><br>
            <label for="nouveauMdp">Nouveau mot de passe :</label>
            <input type="password" name="nouveauMdp" id="nouveauMdp" oninput="validatePassword()" required
                   title="Le mot de passe doit contenir au moins 8 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial."
                   pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,}"
                   aria-required="true" aria-label="Nouveau mot de passe">
            <p id="password-help"><strong>Le mot de passe doit contenir au moins 8 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial.</strong></p>
            <p id="password-error" style="color: red; display: none;">Erreur : Le mot de passe ne respecte pas les critères de sécurité.</p>
            <input type="submit" value="Enregistrer les modifications">
        </form>
    </fieldset>
    <br><br>
    <p>Vous pouvez également <a href="../vue/vueConnexion.php">vous connecter</a> avec vos nouvelles informations.</p>
</div>
<script>
