  ...
  <header class="border-bottom lh-1 py-3">
    <div class="row flex-nowrap align-items-center">
      ...
      <div class="col d-flex justify-content-end">
        ...
        <a class="btn btn-dark me-3" href="./vue/vueInscription.php" aria-label="Inscription">Inscription</a>
        <a class="btn btn-dark" href="./vue/vueConnexion.php" aria-label="Connexion">Connexion</a>
      </div>
...
<main class="container">
  ...
  <div class="col-md-7 text-center my-auto">
    ...
    <p class="lead"></p>
    <button class="btn btn-primary btn-lg mt-3" onclick="redirectToLoginPage('vueAfrique.php')">Découvrir</button>
  </div>
  <div class="col-md-5">
...
<div class="row featurette">
  <div class="col-md-7 order-md-2 text-center my-auto">
    ...
    <button class="btn btn-primary btn-lg mt-3" onclick="redirectToLoginPage('/vue/vueAmerique_du_Sud.php')">Découvrir</button>
  </div>
...
<div class="row featurette">
  <div class="col-md-7 text-center my-auto">
    ...
    <button class="btn btn-primary btn-lg mt-3" onclick="redirectToLoginPage('/vue/page3.php')">Découvrir</button>
  </div>
  <div class="col-md-5">
...
<div class="row featurette">
  <div class="col-md-7 order-md-2 text-center my-auto">
    <h2 class="featurette-heading fw-normal lh-1">Oh yeah, it’s that good. <span class="text-body-secondary">See for yourself.</span></h2>
    <p class="lead">Another featurette? Of course. More placeholder content here to give you an idea of how this layout would work with some actual real-world content in place.</p>
    <button class="btn btn-primary btn-lg mt-3" onclick="redirectToLoginPage('/vue/page4.php')">Découvrir</button>
  </div>
  <div class="col-md-5 order-md-1">
    <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-bg)"/><text x="50%" y="50%" fill="var(--bs-secondary-color)" dy=".3em">500x500</text></svg>
  </div>
