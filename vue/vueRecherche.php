<?php
include_once("../controleur/rechercher.php");

// Vérifier si un mot-clé de recherche a été soumis
if(isset($_GET['recherche'])){
    $motCle = $_GET['recherche'];
    // Effectuer la recherche en utilisant la fonction du modèle
...
<div class="nav-scroller py-1 mb-3 border-bottom">
  <nav class="nav nav-underline justify-content-center">
    ...
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"><strong class="fs-5 fw-bold">Résultats de la recherche</strong> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
...
<?php
    ...
    if (!empty($resultats)) {
        ...
        foreach ($resultats as $resultat) {
            echo "<li>" . htmlspecialchars($resultat['NomTenue'] ?? $resultat['NomAccessoire']) . "</li>";
            // Vous pouvez afficher d'autres informations sur la tenue ou l'accessoire ici
        }
        echo "</ul>";
    } else {
