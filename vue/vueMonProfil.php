    ...
    <main>
        <div class="profile-card">
            <div class="profile-details">
                ...
                <p><strong>Nom :</strong> <?php echo isset($utilisateur['nom']) ? htmlspecialchars($utilisateur['nom']) : ''; ?></p>
                <p><strong>Prénom :</strong> <?php echo isset($utilisateur['prenom']) ? htmlspecialchars($utilisateur['prenom']) : ''; ?></p>
                <p><strong>Adresse e-mail :</strong> <?php echo isset($utilisateur['mailU']) ? htmlspecialchars($utilisateur['mailU']) : ''; ?></p>
                <!-- Ajoutez d'autres informations ici -->
            </div>
            <div class="profile-actions">
                <!-- Ajoutez le formulaire pour supprimer le compte -->
                <form action="supprimerCompte.php" method="post">
                    <input type="submit" name="supprimerCompte" value="Supprimer mon compte" onclick="return confirm('Êtes-vous sûr de vouloir supprimer votre compte ? Cette action est irréversible.')">
                </form>
                <!-- Ajoutez un lien pour se déconnecter -->
                <a href="./?action=deconnexion">Se déconnecter</a>
                <!-- Ajoutez un lien pour modifier le compte -->
                <a href="vueModifierProfil.php">Modifier mon compte</a>
            </div>
        </div>
    </main>
