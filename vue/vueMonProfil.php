...
<body>
    ...
    <a href="./vue/vueAccueil.php">
      <img src="photos/Logo_Cultural_Couture.png" class="logo" width="90" height="80" alt="Logo du site web">
    </a>
    <br>

    <div style="margin-left: 20px;">
    Votre texte décalé à gauche de 20 pixels.

    <li><a href="./?action=defaut" style="color: white;">Accueil</a></li>
    
      <li><a href="./?action=profil" style="color: white;">Profil</a></li>
