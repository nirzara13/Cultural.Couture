...
<div class="nav-scroller py-1 mb-3 border-bottom">
  <nav class="nav nav-underline justify-content-center">
    ...
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"><strong class="fs-5 fw-bold">Mes Favoris</strong> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    ...
    if (!empty($liste_favoris)) {
        ...
        foreach ($liste_favoris as $favori) {
            echo "<li>";
            if ($favori['type_contenu'] == 'Tenue') {
                echo "Tenue: " . $favori['NomTenue'];
            } elseif ($favori['type_contenu'] == 'Accessoire') {
                echo "Accessoire: " . $favori['NomAccessoire'];
            }
            echo "<br>";
            // Afficher la photo si elle est disponible
            if (!empty($favori['cheminP'])) {
                echo "<img src='" . $favori['cheminP'] . "' alt='Photo'>";
            }
            echo "</li>";
        }
        echo "</ul>";
    ...
    <!-- Ajoutez ici d'autres éléments HTML ou du contenu dynamique selon vos besoins -->
