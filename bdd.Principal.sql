...
--Table que j'ai voulu utilisé pour afficher les pays des utilisateurs
--CREATE TABLE pays (
...
--Table pas utile mais à ne pas supprimer
...
--Toutes ces inserts ne sont pas utiles pour le moment, c'était pour tester les fonctionnalités
--Ne pas faire les inserts. Le faire si besoin pour les utilisateurs.
--Car mes fonctionnalités pour les tenues,accessoires et photo ne fonctionnent pas.


-- Exemple d'insertion de données dans la table photo
INSERT INTO photo (idP, cheminP, Id_Tenue, Id_Accessoire) VALUES (1, 'chemin/vers/photo1.jpg', 1, 1);
INSERT INTO photo (idP, cheminP, Id_Tenue, Id_Accessoire) VALUES (2, 'chemin/vers/photo2.jpg', 2, NULL);
INSERT INTO photo (idP, cheminP, Id_Tenue, Id_Accessoire) VALUES (3, 'chemin/vers/photo3.jpg', NULL, 3);
